...
open class ImageSlideshowItem: UIScrollView, UIScrollViewDelegate {
    ...
    public let image: InputSourceProtocol
    ...
    */
    init(image: InputSourceProtocol, zoomEnabled: Bool, activityIndicator: ActivityIndicatorView? = nil, maximumScale: CGFloat = 2.0) {
